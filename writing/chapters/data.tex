...
\begin{itemize}
    ...
    settlement; Codes~2, 3, 4, 6, 12, 14, 15, 17, 18, 19
    $\to$ dismissal. Code~6 (judgment on motion) represents
    terminal disposition by granted motion to dismiss or
    summary judgment. Trial codes, transfer codes, remands,
...
\midrule
A (Primary)  & 12,968 & 2,015 & 9,702 & 1,251 & 15.5 & 74.8 \\
B (Liberal)  & 12,968 & 3,819 & 7,898 & 1,251 & 29.4 & 60.9 \\
C (Expanded) & 12,968 & 4,133 & 7,898 &   937 & 31.9 & 60.9 \\
\bottomrule
\end{tabular*}
\end{table}

Under Scheme~A, 15.5\% of cases settle and 74.8\% are
dismissed, with 9.6\% censored. The Scheme~A settlement
...
dismissals: median 2.53 years versus 1.53 years. The
...
Dismissal  & 9,702 & 2.19 & 1.53 & 0.33 & 3.22 \\
\bottomrule
\end{tabular*}
\end{table}
...
\midrule
Pre-PSLRA   & 1,032  & 367   & 576   & 89    & 35.6 & 55.8 \\
Post-PSLRA  & 11,936 & 1,648 & 9,126 & 1,162 & 13.8 & 76.5 \\
\midrule
\textbf{Total} & \textbf{12,968} & \textbf{2,015} & \textbf{9,702} & \textbf{1,251} & \textbf{15.5} & \textbf{74.8} \\
\bottomrule
\end{tabular*}
\end{table}
