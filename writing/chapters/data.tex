...
We begin with all civil cases coded as NOS~850 (``Securities, Commodities, and Exchange'') filed from 1990 onward, yielding 65,899 cases. The 1990 start date balances sample size against data quality and provides a meaningful pre-PSLRA comparison period. We then retain cases with the IDB class action flag equal to~1, reducing the sample to 13,708 cases (20.8\% of NOS~850). Finally, we exclude cases with non-positive computed durations---740 zero-duration administrative artifacts that represent same-day processing entries rather than substantive resolutions---yielding a final analysis sample of \textbf{12,968} federal securities class actions filed between 1990 and 2024.
